...
export class EditComponent implements OnInit {
  ...
  edit(){
    ...
    encomienda.id = this.fgValidacion.controls["encomienda"].value;
    encomienda.descripcion = this.fgValidacion.controls["encomienda"].value;
    encomienda.peso = this.fgValidacion.controls["encomienda"].value;
    encomienda.presentacion = this.fgValidacion.controls["encomienda"].value;
    encomienda.tipo = this.fgValidacion.controls["encomienda"].value;
